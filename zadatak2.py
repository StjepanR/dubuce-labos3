...
def initialize_model(embedding_matrix):
	return MyModel(embedding_matrix)
...
if __name__ == '__main__':
	...
	training_loader = torch.utils.data.DataLoader(train_dataset, batch_size=train_batch_size, shuffle=True,
												  collate_fn=pad_collate_fn)
	validation_loader = torch.utils.data.DataLoader(valid_dataset, batch_size=validate_batch_size, shuffle=False,
													collate_fn=pad_collate_fn)
	testing_loader = torch.utils.data.DataLoader(test_dataset, batch_size=test_batch_size, shuffle=False,
												 collate_fn=pad_collate_fn)
